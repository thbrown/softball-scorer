...
/**
 * Data that gets sent the the client browser. Excludes private account info (password stuff)
 */
export interface TopLevelClient {
  /**
  ...
  metadata: {
    ...
    version: number;
    /**
     * Schema for the json used on the browser. Client contains all application data and some account data, but not all account data (password hashes are excluded, for instance).
     */
    scope: "client";
    [k: string]: unknown;
  };
  account: Account & AccountReadOnly;
  /**
