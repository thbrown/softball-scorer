...
export default class CardAccount extends Component<Record<string, never>> {
  handleEmailValidationClick: () => Promise<void>;
  handleDeleteDataClick: () => Promise<void>;
  handleDeleteAccountClick: () => Promise<void>;
  ...
  constructor(props: Record<string, never>) {
    ...
    this.handleEmailValidationClick = async function () {
      let buttonDiv = document.getElementById('email-validation') as HTMLDivElement;
      if (!buttonDiv) return;
    ...
    this.handleDeleteAccountClick = async function () {
      dialog.show_input(
        ...
        async (input: string) => {
          ...
          let buttonDiv = document.getElementById('delete-account') as HTMLDivElement;
          if (!buttonDiv) return;
          buttonDiv.classList.add('disabled');
