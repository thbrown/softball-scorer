...
interface CardStatsPrivateProps {
  team: Team | null;
  tab: string;
  game?: Game | null;
  state?: unknown | null;
...
export default class CardStatsPrivate extends React.Component<CardStatsPrivateProps> {
  ...
  constructor(props: CardStatsPrivateProps) {
    super(props);
  ...
  render() {
    ...
    if (this.props.team && this.props.tab === CardStatsPrivate.GAME_STATS_TAB) {
      tabToShow = (
        <CardStatsGame
    ...
    } else if (this.props.team && this.props.tab === CardStatsPrivate.SHARING_TAB) {
