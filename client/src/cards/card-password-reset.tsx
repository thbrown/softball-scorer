...
interface CardPasswordResetProps {
  token: string;
}

export default class CardPasswordReset extends React.Component<CardPasswordResetProps> {
  token: string;
  handleSubmitClick: () => Promise<void>;

  constructor(props: CardPasswordResetProps) {
    super(props);
    this.state = {};
