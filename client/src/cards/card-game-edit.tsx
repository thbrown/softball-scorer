...
interface CardGameEditState extends Game {}
...
> {
  ...
  handleOpponentNameChange: (value: string) => void;
  handleLineupTypeChange: (newValue: string) => void;

  constructor(props: CardGameEditProps) {
    super(props);
