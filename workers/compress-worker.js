...
self.addEventListener('message', (e) => {
  ...
  if (input.compress) {
    console.log('Performing Compression');
    message = LZString.compress(input.content);
  } else {
    console.log('Performing Decompression');
    message = LZString.decompress(input.content);
  }
